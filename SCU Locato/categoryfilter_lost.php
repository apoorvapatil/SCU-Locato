...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="locl-8">
                <h1 class="page-header">Lost &amp; Found
                    <small>Find your valuables</small>
                </h1>
            </div>
			 </div>
			<div class="row">
        ...
        <!-- /.row -->
            ...
            <div class="row">
                <div class="locl-7">
                    <a href="#">
                        <img class="img-responsive" src="images/lost1.jpg" alt="">
                    </a>
                </div>
                <div class="locl-5">
                    <h3>1</h3>
                    <h4>Spects</h4>
                    <p>Guests who have lost their items while visiting Levi's® Stadium are encouraged to visit one of the Guest Services Stations</p>
            ...
            <div class="row">
                <div class="locl-7">
                    <a href="#">
                        <img class="img-responsive" src="images/lost2.png" alt="">
                    </a>
                </div>
                <div class="locl-5">
                    <h3>2</h3>
            ...
            <div class="row">
                <div class="locl-7">
                    <a href="#">
                        <img class="img-responsive" src="images/lost3.jpg" alt="">
                    </a>
                </div>
                <div class="locl-5">
                    <h3> 3</h3>
                    <h4>Dog</h4>
                    <p>Black and gray (san jose north) pic map. Feb 22 Lost dog white & black (san jose east).</p>
                    <a class="locb locb-primary" href="#">View User<span class="glyphicon glyphicon-chevron-right"></span></a>
                </div>
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                ...
                <div class="locl-7">
                    <a href="#">
                        <img class="img-responsive" src="images/lost4.jpg" alt="">
                    </a>
                </div>
                <div class="locl-5">
                    <h3>4</h3>
            ...
            <div class="row">
                <div class="locl-7">
                    <a href="#">
                        <img class="img-responsive" src="images/lost5.jpg" alt="">
                    </a>
                </div>
                <div class="locl-5">
                    <h3>5</h3>
